...
@Component({
  ...
  standalone: true,
  imports: [ MatTooltipModule, MatIconModule, MatButtonModule, MatCardModule],
...
goToCollection(collection: CollectionItem) {

 location.href = this.collectionPage + collection.col_id;
}
